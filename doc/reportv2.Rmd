---
title: "The Effects of Habitat and Feeding Behavior on the Relationship of Predator-Prey Body Mass"
...
```{r, fig.width=8, fig.height=5, echo=FALSE,fig.cap=paste("Fig.2: *Tthe log of Predator mass vs log of Prey Mass by Specific Habitat*")}
...
```{r, fig.width=8, fig.height=6, echo=FALSE,fig.cap=paste("Fig.3:*The log of Predator mass vs log of Prey mass in each habitat and grouped by Type of Feeding Interaction*")}
...
```{r, echo=FALSE, fig.cap= paste("Fig.5: *FBWAGBWAGBAW*")}
...
```{r, echo=FALSE, fig.cap= paste("Fig.6: *FHAJGAGBA*")}
plot
```
